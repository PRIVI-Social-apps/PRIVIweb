 ...
 *
 * @returns URL to connect to the blockchain
 */
export function getBlockchainNode1URL(): string {
  if (process.env.NODE_ENV === "development") {
    if (process.env.REACT_APP_ENV === "dev_ssl") {
      // When executing [ REACT_APP_ENV='dev_ssl' npm start ]
      return "http://159.65.123.98:4000";
...
export function getBlockchainNode2URL(): string {
  if (process.env.NODE_ENV === "development") {
    if (process.env.REACT_APP_ENV === "dev_ssl") {
      // When executing [ REACT_APP_ENV='dev_ssl' npm start ]
      return "https://node02.priviblockchain.com:4000";
    } else if (process.env.REACT_APP_ENV === "dev") {
      // When executing [ REACT_APP_ENV='dev' npm start ]
      return "http://159.65.123.98:4000";
    } else {
...
export function getBlockchainNode3URL(): string {
  if (process.env.NODE_ENV === "development") {
    if (process.env.REACT_APP_ENV === "dev_ssl") {
      // When executing [ REACT_APP_ENV='dev_ssl' npm start ]
      return "https://node02.priviblockchain.com:4000";
