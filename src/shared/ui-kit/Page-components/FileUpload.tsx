...
import { RemoveIcon } from "components/PriviMusicDao/components/Icons/SvgIcons";
      ...
      {photo ? (
        ...
        >
          {type === "image" ? (
            ...
            <ReactPlayer controls url={URL.createObjectURL(photo)} width="100%" height={200} />
          )}
          {!isEditable && (
          ...
          {isEditable && (
            <Box className="editableBox">
              ...
              <Box
                ...
                ml={2}
                onClick={() => {
                  let selectPhoto = document.getElementById("selectPhoto-" + type);
        ...
        >
          ...
          {isNewVersion && <UploadIcon style={{ stroke: theme ? "white" : "inherit" }} />}
          <Box
              ...
              {theme === "green" ? (
                ...
                <>
                  ...
                  <div style={{ textAlign: "center", marginTop: "8px" }}>
                    <div style={{ color: theme ? "#E0DFF0" : "#54658F", opacity: 0.8 }}>
                      {type === "image"
