...
const DiscordSideBar = React.memo((props: any) => {
  ...
  const [startUserList, setStartUserList] = useState<number>(0);
  const [endUserList, setEndUserList] = useState<number>(0);
    ...
    return (
      <div className="sideBarUser" onClick={() => setSelectedUser(propsFunction.user)}>
        <div
          ...
          style={{
            backgroundImage:
              propsFunction.user && propsFunction.user.url
                ? `url(${propsFunction.user.url}?${Date.now()})`
                : propsFunction.user && propsFunction.user.imageURL
                ? `url(${propsFunction.user.imageURL}?${Date.now()})`
                : "none",
  ...
  if (props.selectedDiscordRoom && props.selectedDiscordRoom.room && props.selectedDiscordRoom.room !== "") {
    return (
              ...
              <div className="row cursor-pointer">
                <div className="sideBarSelectedImage">
                  <div
                    ...
                    style={{
                      backgroundImage:
                        selectedUser && selectedUser.url ? `url(${selectedUser.url}?${Date.now()})` : "none",
                      backgroundPosition: "center",
                      backgroundRepeat: "no-repeat",
                      backgroundSize: "cover",
                      borderRadius: "50%",
                ...
                <div className="info-block">
                  <h4>{selectedUser && selectedUser.userName ? selectedUser.userName : null}</h4>
