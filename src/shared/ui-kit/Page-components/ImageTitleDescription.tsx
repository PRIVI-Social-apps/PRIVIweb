    ...
    >
      ...
      >
        <Box display="flex" alignItems="center">
          <Box fontSize={"18px"} fontWeight={400} color={theme === "dark" ? "white" : theme === "green" ? Color.GrayDark : "#181818"}>
            {titleTitle}
          </Box>
          <img
            ...
            alt={"info"}
            style={{
              width: infoSize ? infoSize * 2 : "12px",
              height: infoSize ? infoSize * 2 : "12px",
              marginLeft: "4px",
            }}
          />
        </Box>
      ...
      <Grid
        ...
        xs={12}
        md={imageSize === 12 ? 12 : 6}
        style={{ display: "flex", flexDirection: "column", marginTop: !theme || imageSize === 12 ? 16 : 0 }}
      >
        {photoTitle ? (
        ...
        {photoImg ? (
          ...
          >
            ...
            />
            <Box color={theme === "dark" ? "white" : "#99a1b3"} fontSize={18} fontWeight={400}>
              Drag Image Here
              {imageSize === 12 ? (
                <Box>
                  or{" "}
