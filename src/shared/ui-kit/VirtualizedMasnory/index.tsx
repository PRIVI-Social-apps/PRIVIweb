...
import ClaimablePodCard from "components/legacy/Pods/Pod-Claimable-Card";
import CommunityCard from "components/legacy/Communities/components/CommunityCard";
import AcquisitionCard from "components/legacy/Communities/CommunityPage/components/Acquisitions/components/AcquisitionCard";
...
export const VirtualizedMasnory = ({
  ...
  const cellPositioner = React.useRef<any>(createCellPositioner({
