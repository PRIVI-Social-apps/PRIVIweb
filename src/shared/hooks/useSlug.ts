  ...
  useEffect(() => {
    if (
      ...
      ((location.pathname.includes("profile") && !location.pathname.includes("/0x")) ||
        (location.pathname.includes("privi-social") && !location.pathname.includes("/0x")) ||
        location.pathname.includes("communities") ||
        location.pathname.toLowerCase().includes("privi-dao") ||
      ...
      const idUrl =
        ...
        (location.pathname.split("/").length === 3 &&
          location.pathname.includes("privi-social") &&
          !location.pathname.includes("/0x")) ||
        location.pathname.includes("communities") ||
        location.pathname.toLowerCase().includes("privi-dao")
