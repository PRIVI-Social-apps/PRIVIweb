...
export const MessageItem = ({ user, message, chat, lastRow, mediaOnCommunity }) => {
  const { userInfo } = chat;
        ...
        {message.type && message.type === "photo" ? (
          <div className={classes.container}>
            ...
            <div
              ...
              style={{
                backgroundImage: `url(${message.url}?${Date.now()})`,
          ...
          <div className={classes.container}>
            ...
            <div className={classes.audioContainer}>
              <Waveform
                url={
                  mediaOnCommunity
                    ? `${URL()}/mediaOnCommunity/getMessageAudio/${message.chatId}/${message.from}/${message.id
                    }`
          ...
          <div className="item-content">
            ...
            <div className="item-file">
              ...
              <div onClick={() => {
                ...
                className="item-file-icon"><SvgIcon>
                  <DownloadSolid />
                </SvgIcon></div>
            </div>
            <Moment fromNow className={classes.itemMeta}>
