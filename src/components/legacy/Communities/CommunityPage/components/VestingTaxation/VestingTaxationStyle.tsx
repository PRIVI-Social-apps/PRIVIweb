...
export const Card = styled.div<CardProps>`
  ...
  border-radius: 16px;
  padding: 24px;
  margin-bottom: ${p => p.margin ? grid(3) : 0};
`;
...
export const Text = styled.span<TextProps>`
  ...
  ${p => p.mt && css`margin-top: ${grid(p.mt)};`};
  ${p => p.mb && css`margin-bottom: ${grid(p.mb)};`};
  ${p => p.ml && css`margin-left: ${grid(p.ml)};`};
  ${p => p.mr && css`margin-right: ${grid(p.mr)};`};
`;
...
export const CheckIcon = () => (
  <svg width="18" height="13" viewBox="0 0 18 13" fill="none">
    <path d="M17.0001 1L6.0001 12L1 7" stroke="#65CB63" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
)

export const LinkIcon = () => (
  <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M16.8242 0.79884L6.82418 10.7988M16.8242 0.79884L16.8243 6.79884M16.8242 0.79884L10.8242 0.798828M6.82422 0.79884H0.824219V16.7988H16.8242V10.7988" stroke="#727F9A" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
)