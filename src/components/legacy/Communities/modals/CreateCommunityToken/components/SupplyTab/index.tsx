...
import { Radio, RadioGroup, FormControlLabel, FormControl, Tooltip, Fade } from "@material-ui/core";
...
export default function CreateCommunityTokenSupplyTab({ communityToken, setCommunityToken }) {
