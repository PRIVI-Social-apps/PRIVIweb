...
import { Text } from "components/legacy/Communities/CommunityPage/components/VestingTaxation/VestingTaxationStyle";
...
const NewProposalModal = ({ open, handleClose, proposalId, proposalType }) => {
