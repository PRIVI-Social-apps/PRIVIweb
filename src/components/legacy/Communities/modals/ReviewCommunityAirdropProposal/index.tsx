...
import { ProgressAcceptIcon, ProgressDeclineIcon, ProgressPendingIcon, Text, useStyles } from "components/legacy/Communities/CommunityPage/components/VestingTaxation/VestingTaxationStyle";
