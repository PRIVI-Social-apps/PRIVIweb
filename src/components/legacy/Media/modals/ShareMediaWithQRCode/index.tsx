...
import { shareMediaQRCodeModalStyles } from "./index.styles";
import { Modal } from "shared/ui-kit";

const qrCodeIcon = require("assets/icons/qrcode.png");

export const ShareMediaWithQRCode = ({ mediaId, shareLink, onClose, isOpen }) => {
  const classes = shareMediaQRCodeModalStyles();
  ...
  const processDownload = isSVG => {
    ...
    if (isSVG) {
      ...
      if (svg) {
        ...
        downloadLink.download = `${mediaId}.svg`;
      }
    } else {
      ...
      if (qrCode) {
        ...
        downloadLink.download = `${mediaId}.png`;
      }
    }
