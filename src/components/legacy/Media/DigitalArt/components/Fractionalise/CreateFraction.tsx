...
const CreateFraction = (props: any) => {
  ...
  useEffect(() => {
    if (props.media) {
      const price = props.media.Price ?? props.media.NftConditions.Price > 0
      ...
      setMedia({
        ...
        Price: price,
        FundingToken:
          props.media.RecordToken ?? props.media.NftConditions.NftToken ?? props.media.FundingToken ?? "PRIVI",
  ...
  return (
    <Modal className={classes.modalContainer} open={props.open} onClose={props.handleClose}>
      <div className={classes.paper}>
        ...
        <Box display="flex">
          <Box style={{ width: "50%" }}>
            <CurrentPriceLabel title="Current Price" price={formatNumber(media.Price, media.FundingToken, 4)} />
          </Box>
          <Box style={{ width: "50%" }}>
                ...
                <TextField
                  ...
                  InputProps={{
                    inputProps: {
                      ...
                      max:
                        (media.Price ??
                          0 / ((rateOfChange[fractionFundingToken] ?? 1) / (rateOfChange[media.FundingToken] ?? 1))) *
                        1.2,
                    },
                  }}
                  className={classes.roundInputBox}
