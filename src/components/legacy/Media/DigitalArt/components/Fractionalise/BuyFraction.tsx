                            ...
                            <Box display="flex" className={classes.userItem}>
                                ...
                                <Box display="flex" className={classes.goToUser}>
                                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M17.0625 1.04042L7.06247 11.0404M17.0625 1.04042L17.0625 7.04041M17.0625 1.04042L11.0625 1.04041M7.0625 1.04042H1.0625V17.0404H17.0625V11.0404" stroke="#727F9A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                </Box>
                            </Box>
                            <Divider />
