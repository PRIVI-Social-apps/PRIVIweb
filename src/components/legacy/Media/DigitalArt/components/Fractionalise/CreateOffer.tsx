...
const CreateOffer = (props: any) => {
    ...
    useEffect(() => {
        ...
        if (props.media) {
            ...
            if (props.media.Fractionalise && props.media.Fractionalise.PodAddress) newMedia.Address = props.media.Fractionalise.PodAddress;
        ...
        <Modal className={classes.modalContainer} open={props.open} onClose={() => props.handleClose()} >
            <div className={classes.paper}>
                ...
                <Box display="flex" p={1} style={{ alignItems: "center" }}>
                    ...
                    <Box style={{ width: "50%" }} >
                        <TextField variant="outlined" className={classes.roundInputBox}
                ...
                <Box display="flex" p={1} style={{ alignItems: "center" }}>
                    ...
                    <Box style={{ width: "50%" }} >
                        <Box display="flex" style={{ textAlign: "center", alignItems: "center", marginTop: "16px" }}>
                            <Box style={{ width: "50%" }} >
                                <TextField type='number' variant="outlined" className={classes.roundInputBox}
                                    value={selectedPrice}
                                    onChange={(event) => {
                ...
                <Box display="flex">
                    <Box style={{ width: "100%" }}>
                        <Button disabled={disabled} className={classes.fractionaliseButton} variant="contained" onClick={handlePlaceOrder}>Place Order</Button>
                    </Box>
                </Box>
