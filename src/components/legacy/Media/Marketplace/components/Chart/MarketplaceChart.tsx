...
import "./MarketplaceChart.css";

const PrintMarketplaceChart = (config, token) => {
  ...
  if (config.config) {
    ...
    if (data.length) {
      ...
      if (data.length > 1) yesterdayPrice = parseFloat(data[data.length - 2].y).toFixed(3);
    }
  }
...
export default PrintMarketplaceChart;
