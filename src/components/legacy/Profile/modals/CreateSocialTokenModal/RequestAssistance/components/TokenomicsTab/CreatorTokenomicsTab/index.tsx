...
import { useCreateTokenStyles } from "components/legacy/Profile/modals/CreateSocialTokenModal";
...
export default function CreatorTokenomicsTab({
  ...
  const tokenClasses = useCreateTokenStyles();
  ...
  return (
    <div className={classes.root}>
      <Box display="flex" alignItems="center" justifyContent="space-between" width="100%" className={classes.title}>
      ...
      <Box display="flex" alignItems="center" className={classes.token}>
        ...
        <div>
          <label className={classes.tokenLabel}>Total Amount</label>
          <InputWithLabelAndTooltip
