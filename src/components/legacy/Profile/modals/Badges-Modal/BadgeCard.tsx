...
import IndividualBadgeModal from "../../components/Badge-hexagon/IndividualBadgeModal";
        ...
        <div className={classes.badgeCard} onClick={handleOpenModal}>
          ...
          <div className={classes.cardHeader}>
            ...
            <div className={classes.cardStats}>
              ...
              <div className={classes.likes}>
                <div className={classes.likesTitle}>💜 Likes</div>
                <div className={classes.likesContent}>{item.Likes ? item.Likes.length : 0}</div>
              </div>
          ...
          <div className={classes.info}>
            <div className={classes.infoCreator}>
              <div
                className={classes.infoCreatorAvatar}
                style={{
                  backgroundImage:
                    item.userImage !== ""
                      ? `url(${item.userImage})`
