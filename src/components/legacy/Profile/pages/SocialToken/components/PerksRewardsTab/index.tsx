...
export default function PerksRewardsTab({ socialToken, isCreator, triggerPerks, setTriggerPerks }) {
  ...
  const [redeemCost, setRedeemCost] = useState<number>(1000);
  const [shares, setShares] = useState<number>(450);
  ...
  return (
    <Box width="100%">
      ...
      <Box display="flex" alignItems="center" width="100%" justifyContent="space-between" marginBottom="70px">
        ...
        <Box display="flex" flexDirection="column" alignItems="flex-end">
          ...
          <Box display="flex" alignItems="center">
            <span style={{ marginRight: "17px" }}>Redeem Cost</span>
            <MintSlider
              min={0}
              step={100}
              max={10000}
        ...
        <Box display="flex" flexDirection="column" alignItems="flex-end" marginLeft={"20px"}>
          <Box display="flex" width="210px" justifyContent={"space-between"}>
            <span>0</span>
            <span>+100k</span>
          </Box>
          <Box display="flex" alignItems="center">
            <span style={{ marginRight: "17px" }}>Shares</span>
            <MagentaSlider
              min={0}
              step={100}
              max={10000}
