...
import "../../Exchange/modals/OfferModal.css";

export default function OfferLendModal(props) {
  //hooks
  ...
  const [offerElems, setOfferElems] = useState<Map<string, string>>(new Map([]));
  ...
  useEffect(() => {
    ...
    if (props.lending.DateDue) {
      setTime(getStyledTime(new Date().getTime(), new Date(props.lending.DateDue).getTime(), true));
    }
    //load tokens
    loadTokens();
  ...
  return (
    <Modal
      ...
      className="modal"
    >
      <div className="modal-content white-inputs offer-create-modal">
        ...
        <div className="offer-data">
          <div
            ...
            style={{
              backgroundImage:
                props.lending.Token && props.lending.Token.length > 0
                  ? `url(${require(`assets/tokenImages/${props.lending.Token}.png`)})`
                  : "none",
          ...
          <div className="column">
            <span>TOKEN</span>
            <p>{props.lending.Token}</p>
          </div>
          <div className="column">
            <span>QUANTITY</span>
            <p>{props.lending.Quantity}</p>
          </div>
          <div className="column">
            <span>COLLATERAL</span>
            <p>{`${props.lending.Collateral.Quantity} ${props.lending.Collateral.Token}`}</p>
          </div>
          <div className="column">
        ...
        <div className="flexRowInputs">
          <div>
            <div className="flexRowInputs">
              ...
              <img className="infoIconCreatePod" src={require("assets/icons/info_icon.png")} alt={"info"} />
            </div>
            <div className="flexRowInputs">
        ...
        {offerError.length > 0 ? <div className="error">{offerError}</div> : null}
        ...
        <div className="footer">
          ...
          <button onClick={handleLend} disabled={disableSubmit}>
            Offer lending
          </button>
        </div>
      </div>
