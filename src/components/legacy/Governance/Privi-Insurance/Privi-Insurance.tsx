...
const PriviInsurance = () => {
  ...
  const loadData = () => {
    ...
    trackPromise(
      axios.get(`${URL()}/stake/getStakedHistory/pINS`).then((res) => {
        const resp = res.data;
        if (resp.success) {
          const xs: string[] = [];
          const ys: number[] = [];
    ...
    // get total members
    trackPromise(
      axios.get(`${URL()}/stake/getTotalMembers/pINS`).then((res) => {
        const resp = res.data;
        if (resp.success) {
        ...
        <div className="firstRowPriviEcosytem">
          <div className="firstColumnPriviEcosystem">
            ...
            <div className="mainValueFirstRowPriviEcosystem">
              {formatNumber(stakedAmount, "pINS", numOfDecimals)}
            </div>
          </div>
          <div className="secondColumnPriviEcosystem">
            <div className="columnValuesPriviEcosystem">
              ...
              <div className="valueFirstRowPriviEcosystem">
                {formatNumber(dailyReturn, "% pINS", numOfDecimals)}
              </div>
            </div>
            <div className="columnValuesPriviEcosystem">
              <div className="headerFirstRowPriviEcosystem">Weekly returns</div>
              <div className="valueFirstRowPriviEcosystem">
                {formatNumber(weeklyReturn, "% pINS", numOfDecimals)}
              </div>
            </div>
            <div className="columnValuesPriviEcosystem">
              <div className="headerFirstRowPriviEcosystem">
              ...
              <div className="valueFirstRowPriviEcosystem">
                {formatNumber(monthlyReturn, "% pINS", numOfDecimals)}
              </div>
            </div>
          </div>
