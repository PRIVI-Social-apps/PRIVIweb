...
export default function CreateClaimablePodModal(props) {
  ...
  const handleOpenSignatureModal = () => {
    ...
    songInfos.forEach(songInfo => {
      ...
      const artist = songInfo.artist_name;
      ...
      reader.addEventListener(
        ...
        async function () {
          ...
          setMetaData({
            ...
            name: file.name,
            url: resp.data.url,
            isExist: resp.data.isExist,
          });
          if (bitrate / 1024 < minBitrate || resp.data.isExist) {
            return;
          }
          setUpload2(file);
        },
  ...
  return (
    ...
    >
      <div className={classes.modalContent}>
        ...
        <h2>Upload a song and earn if the artist claims it!</h2>
        {!isReviewMode ? (
          <>
            <Grid container spacing={3}>
                  ...
                  {metadata && metadata.name && (
                    <Box className={classes.songList}>
                      <Box className={classes.songInfo}>
                        ...
                        {(metadata.bitrate / 1024 < minBitrate || metadata.isExist) && (
              ...
              <Grid item xs={6}>
                <h5>Choose Blockchain Network</h5>
              ...
              <Grid item xs={6}>
                ...
                <p style={{ fontSize: 11 }}>Minimum price per second is pUSD 0.1 .</p>
              </Grid>
              {/* <Grid item xs={6}>
                <h5>Creator Share (%)</h5>
                <TextField
                ...
                />
                <p>Maximum creator share is 1%</p>
              </Grid>
              <Grid item xs={6}>
                <h5>Sharing Share (%)</h5>
                <TextField
                  ...
                  placeholder=""
                  type="number"
                  value={sharingSharePercent}
                  InputProps={{ inputProps: { min: 0, max: 1 } }}
                  onChange={e => setSharingSharePercent(e.target.value)}
                />
              </Grid> */}
              <Grid item xs={12} className={classes.priviFreeZone}>
                <span className={classes.fire}>🔥</span>
                <div>
                  <span>Privi Free Zone</span>
                  <p>
                    Use the minimum price per second (pUSD 0.1) to establish a Privi Free Zone for this media.
                    This means that users who have a stake on Privi Tokens will be able to use them to listen
                    to this song.
                  </p>
                </div>
              </Grid>
            ...
            <Box className={classes.actionButtons}>
              <SecondaryButton size="small" onClick={() => props.handleClose()}>
                Back
              </SecondaryButton>
