              ...
              >
                <MuiPickersUtilsProvider utils={DateFnsUtils}>
                  <KeyboardDatePicker
                    ...
                    value={props.pod.FundingDate ? new Date(props.pod.FundingDate*1000): new Date().setDate(new Date().getDate() + 1)}
                    onChange={(e: any) =>
                      props.setPod(prev => ({ ...prev, FundingDate: Math.floor(new Date(e).getTime()/1000)}))
                    }
