...
export default function ArtistCard({ data, customSize }: { data: any; customSize?: any }) {
  ...
  return (
    <Box
      ...
      onClick={() => history.push(`/privi-music-dao/artists/${data.id}`)}
    >
      <Box
        display="flex"
        flexDirection="column"
      ...
      >
        ...
        <Box display="flex" flexDirection="row" alignItems="center" justifyContent="space-between">
          <PrimaryButton size="small" className={commonClasses.primaryButton}>
            Claim
          </PrimaryButton>
      ...
      >
        ...
        <PrimaryButton className={classes.follow} size="small">
          Follow
        </PrimaryButton>
      </Box>
    </Box>
